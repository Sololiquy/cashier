      ...
      <>
         <div className={`gap-3 flex flex-row`}>
            ...
            <div className={`${style.tab_info}`}>
               ...
               <span className={`text-xl`}>Rp. {data.price}</span>
            </div>
            <div className={`${style.tab_qty} text-2xl`}>x{data.quantity}</div>
            <div className={`${style.tab_total} text-2xl`}>Rp. {data.quantity * data.price}</div>
         </div>
      </>
   );
}
