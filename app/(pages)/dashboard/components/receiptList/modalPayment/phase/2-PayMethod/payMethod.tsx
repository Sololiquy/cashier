      ...
      <>
         <div className={`flex flex-col gap-3`}>
            <label className={`flex p-3 gap-3 rounded-lg bg-gray-700 items-center`}>
               <input className={`size-5`} type="radio" name="payment" value="1" checked={paymentMethod === 1} onChange={() => setPaymentMethod(1)} />
               <span className={`text-xl tracking-wider`}>Cash</span>
            </label>

            <label className={`flex p-3 gap-3 rounded-lg bg-gray-700 items-center`}>
               <input className={`size-5`} type="radio" name="payment" value="2" checked={paymentMethod === 2} onChange={() => setPaymentMethod(2)} />
